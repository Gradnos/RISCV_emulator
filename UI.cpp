...
namespace UI {
    ...
    static void mainWindow() {
        ...
        float w = m_mainWindowSize.x * ratioW; //text editor width
        float h = m_mainWindowSize.y * ratioH; // visualiser height
